...
define(["dojo/_base/declare",
  ...
  function(declare, lang, on, aspect, Deferred, domClass, portalUrlUtils, portalUtils,
    ...
    util, SearchPane, AddFromUrlPane, AddFromFilePane, LayerListPane,AddFromGISPane) {
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        this._getUser().then(function(user) {
          ...
          else if (self.addfromGISPane) {
            self.addfromGISPane.startup();
          }
          ...
          self._initFooter(self.tabContainer, {
            ...
            "addFromGISWidget": self.addfromGISPane
          });
          self._initListeners();
          self.resize();
      ...
      _initTabs: function(){
        ...
        if(config.addFromGIS && config.addFromGIS.allow)
        {
            
            this.addfromGISPane = new AddFromGISPane({
            wabWidget: this
          },this.gisNode);
          tabs.push({
            title: "Intranet GIS",
            content: this.addfromGISPane.domNode
          });
        }
